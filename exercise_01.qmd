...
Why does this code not work? __The code below does not work to display the given 10 value to my variable because it is mispelled, without a proper "i" in vairable. Upon retyping it with regular letters, it works.__
